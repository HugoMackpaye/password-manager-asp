...
<form class="form-signin" role="form">
        <h2 class="form-signin-heading">Sign up for new account</h2>
        ...
        <asp:TextBox ID="TextBox3" CssClass="form-control" placeholder="Repeat password" runat="server" required></asp:TextBox>
