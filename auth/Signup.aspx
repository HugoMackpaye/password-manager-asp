...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:CreateUserWizard ID="CreateUserWizard1" runat="server" CancelDestinationPageUrl="~/auth/Login.aspx" ContinueDestinationPageUrl="~/user/Home.aspx" RequireEmail="True" OnCreatedUser="CreateUserWizard1_CreatedUser">
        <WizardSteps>
